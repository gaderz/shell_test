...
/**
 * replace_aliases - replaces aliases in command args with their corresponding
...
char **replace_aliases(char **args)
{
        ...
        while (args[arg_index])
        {
                ...
                for (alias_index = 0; current_alias; alias_index++, current_alias = current_alias->next)
                {
